   ...
   <div id="app">
      ...
      <br></br>
            ...
            <div>
               ...
               <a href="#" target="_blank" class="btn btn-outline-primary btm-sm mb-2 ml-2 mr-1" style="float: left;"><i class="far align-middle fa-fw fa-download mr-1"></i>download client</a>
            </div>
            ...
            <div class="container-fluid content-row d-none d-lg-block">
               <div class="row">
                  ...
                  if ($FoundRows > 0) {
                     ...
                     <div class='game-card h-100 video-card' style='' onclick='". $Game['id'] ."'>
                        <span class='thumbnail'>
                           <img src='". $baseUrl ."/app/gethumb.php?id=". $Game['id'] ."&asset=game'  class='card-img-top'>
                           <div style='position: absolute; top: 0px;'><span class='badge badge-danger badge-notification'>". $Game['version'] ."</span></div>
